...
/**
 * A class representing a fraction of integer values. The class provides
 * functionality for simplifying the fraction and performing the basic fraction
 * computations.
 * 
 * @author Claudio
 */
public class Fraction {
	...
	/**
	 * Add this fraction to the specified fraction and returns it as a new
	 * fraction (not simplified). It does not modify this fraction.
	 * 
	 * @param f
