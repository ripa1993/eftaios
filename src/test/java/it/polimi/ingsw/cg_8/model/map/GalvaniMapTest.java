...
public class GalvaniMapTest {
    ...
    public void testGetSectorByC2() {
        Sector mSector;
        try {
            mSector = testMap.getSectorByCoordinates(new Coordinate(10, 0));
    ...
    public void testGetSectorByC3() {
        Sector mSector;
        try {
            mSector = testMap.getSectorByCoordinates(new Coordinate(5, 0));
            boolean result = false;
    ...
    public void testGetSectorByC4() {
        Sector mSector;
        try {
            mSector = testMap.getSectorByCoordinates(new Coordinate(6, 1));
            boolean result = false;
